...
export function InvestmentInfoComponent({header, info, icon}: { header: string, info: string, icon: ReactElement }) {
    return <div
        className="flex basis-0 flex-grow min-w-64 rounded p-2 px-4 bg-black/5 justify-between items-center cursor-pointer hover:bg-black/10 transition duration-300">
        <div>
                        ...
                        <ul className="space-y-4 mb-4">
                            <li>
                                ...
                                <label for="job-1"
                                    ...
                                    <svg className="w-4 h-4 ms-3 rtl:rotate-180 text-gray-500 dark:text-gray-400" aria-hidden="true"
